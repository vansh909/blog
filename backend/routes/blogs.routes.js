...
const { createBlogs, updateBlogs, deleteBlogs, getAllBlogs, blogLikes, seeFollowingBlogs} = require('../controllers/blogs.controller')
const {verifyUser} = require('../middlewares/auth.middleware')

router.post('/', verifyUser, createBlogs);
